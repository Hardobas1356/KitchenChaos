...
public class CuttingCounter : BaseCounter, IHasProgress
{
    ...
    public override void InteractAlternate(Player player)
    {
        ...
        {
            //Cut the object
            KitchenObjectSO newKitchenObjectSO = GetOutputForInput(GetKitchenObject().GetKitchenObjectSO());
            if (newKitchenObjectSO != null)
            {
                ...
                if (cuttingProgress >= cuttingRecipeSO.cuttingProgressMax)
                {
                    ...
                    KitchenObjects.SpawnKitchenObject(newKitchenObjectSO, this);
                }
            }
        }
    }
    ...
    {
        if ((GetCuttingRecipeSOWithInput(inputKitchenObjectSO) != null)) return true;
        else return false;
    }
