...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            ...
            canMove = moveDirection.x < .5f || moveDirection.x > 0.5f && !Physics.CapsuleCast(transform.position,
            ...
            else
            {
                ...
                canMove = moveDirection.z < .5f || moveDirection.z > 0.5f && !Physics.CapsuleCast(transform.position,
